...
namespace Drupal\ibase_media_embed_mixcloud\Service;
...
//      if ($done) return $store_label; // ???
  ...
  static public function batchProcessEpisodeEndpoint(string $endpoint, $batchId, $channel_id, &$context) {
    $mixcloud = \Drupal::service('ibase_media_embed_mixcloud.service');
  ...
  private function processEpisodeData(array $data): ?EntityInterface {
